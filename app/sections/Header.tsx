    ...
    <>
      <motion.header
        className={`
          ...
          ${isDark ? "bg-stage-black/90 backdrop-blur-md border-b border-stage-red/20" : "bg-stage-cream/90 backdrop-blur-md border-b border-stage-gold/20"}
        `}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
            ...
            {navItems.map((item) => (
              <motion.button
                ...
                className={`
                  ...
                  ${isDark ? "text-stage-silver/70 hover:text-white hover:bg-stage-red/10" : "text-stage-charcoal/70 hover:text-stage-charcoal hover:bg-stage-gold/10"}
                `}
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className={`
                ...
                ${isDark ? "border-stage-red/30 text-stage-silver hover:border-stage-red" : "border-stage-gold/30 text-stage-charcoal hover:border-stage-gold"}
              `}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.button
              ...
              className={`
                ...
                ${isDark ? "border-stage-red/30 text-stage-silver hover:border-stage-red hover:shadow-[0_0_20px_rgba(196,30,58,0.3)]" : "border-stage-gold/30 text-stage-charcoal hover:border-stage-gold hover:shadow-[0_0_20px_rgba(212,175,55,0.3)]"}
              `}
            ...
            <motion.button
              ...
              className={`
                ...
                ${isDark ? "border-stage-red/30 text-stage-silver" : "border-stage-gold/30 text-stage-charcoal"}
              `}
              whileTap={{ scale: 0.9 }}
            >
