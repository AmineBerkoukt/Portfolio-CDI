...
export default function CertificationsCard() {
  ...
  return (
    <section id="certifications" className="scroll-margin py-16 px-4 md:px-8">
            ...
            {certList.map((cert, i) => (
              ...
              >
                <div
                  className={`
                    p-3 rounded-full
                    ${isDark ? "bg-stage-red/10" : "bg-stage-gold/10"}
                  `}
                >
                ...
                <div className={`relative w-20 h-20 overflow-hidden rounded-lg border ${isDark ? "border-stage-red/20 bg-stage-black/30" : "border-stage-gold/20 bg-stage-ivory/50"}`}>
                  <Image
                    src={cert.image}
